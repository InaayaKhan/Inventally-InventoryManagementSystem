    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.php"><img src="images/InvenTally.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
		...
		<?php endif ?>
		<img src="images/original.png" alt="welcome " style="width:100%">
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright By Group11. All right reserved.  <a href="https://colorlib.com/wp/">2021</a>.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
